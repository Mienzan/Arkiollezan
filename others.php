...
?>	  
	...
	<?php
   $query = 'SELECT others.idnumber, others.lastname, others.firstname, others.middlename, others.gender, others.company FROM others';
    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Others</li>
		 <li class="ml-auto">
          <a href="createothers.php">Add Others</a>
         </li>
      </ol>
...
<?php while ($row = mysqli_fetch_assoc($result))  { ?>
      <tr>
	   ...
	   <?php
        ...
        echo '<td> <a  type="button" class="btn btn-success" href="viewothers.php?view='.$row['idnumber'] . '"> VIEW </a></td> ';	
	  echo '</tr> ';
	  ?>
