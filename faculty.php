...
?>	  
	...
	<?php
   $query = 'SELECT faculty.idnumber, faculty.lastname, faculty.firstname, faculty.middlename, faculty.gender, faculty.department FROM faculty';
    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Faculty</li>
		 <li class="ml-auto">
          <a href="createfaculty.php">Add Faculty</a>
         </li>
      </ol>
...
<?php while ($row = mysqli_fetch_assoc($result))  { ?>
      <tr>
	   ...
	   <?php
        ...
        echo '<td> <a  type="button" class="btn btn-success" href="viewfaculty.php?view='.$row['idnumber'] . '"> VIEW </a></td> ';	
	  echo '</tr> ';
	  ?>
