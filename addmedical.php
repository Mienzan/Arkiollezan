...
if(!empty($file_name)) {
   $mysqli->query("INSERT INTO file(file_name, idnumber, semester)
	VALUES('$file_name', '$idnumber', '$semester')") or
	 die($mysqli->error);
}

	$mysqli->query("INSERT INTO medical(idnumber, semester, notes, date, status)
...
if(!empty($file_name)) {
   $mysqli->query("INSERT INTO file(file_name, idnumber)
...
<div class="card-body">
<small>
<form action="addmedical.php" role="form" method="POST" enctype="multipart/form-data"> 
<div class="row">
...
<div class="row">   
	  ...
	  <div class="col-md-12">  
   	  <div style="float:left">Upload a File</div> <br>
	  <div class="form-group">
