...
if(!empty($file_name)) {
   $mysqli->query("INSERT INTO facultyfile(file_name, idnumber)
	VALUES('$file_name', '$idnumber')") or
	 die($mysqli->error);
}

	$mysqli->query("INSERT INTO facultymedical(idnumber, semester, notes, date, status)
...
<form action="addfacultymedical.php" role="form" method="POST" enctype="multipart/form-data"> 
